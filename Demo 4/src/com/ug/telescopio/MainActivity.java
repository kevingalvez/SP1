...
public class MainActivity extends Activity {
    ...
    public void setInputControls(){
    	...
    	android.widget.RadioGroup.OnCheckedChangeListener checkedChangeListener = new android.widget.RadioGroup.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				String option = "";
				switch (checkedId) {
				case R.id.radio0: option = "A"; break;
				case R.id.radio1: option = "B"; break;
				case R.id.radio2: option = "C"; break;
				}
    ...
    public class ButtonListener implements OnClickListener {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			EditText searchQuery = (EditText)findViewById(R.id.textViewSearchQuery);
